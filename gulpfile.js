...
const serverBase = './app/public/wp-content/themes/codeups-inc'; // Local by Flywheelのテーマフォルダまでのパス。dummyの部分を任意のテーマフォルダ名に変える
...
const browserSyncOption = {
  ...
  proxy: 'http://codeups-inc.local' // WordPressサイトの場合(Local by Flywheel)。dummyの部分を任意の名前に変える
};
